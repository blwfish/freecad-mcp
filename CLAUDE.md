...
You have access to 14 MCP tools for controlling FreeCAD. Follow these instructions when using them.
...
- **Bridge** (`working_bridge.py`): 14 MCP tools, async, communicates via MCP protocol over stdio
