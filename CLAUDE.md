...
You have access to 13 MCP tools for controlling FreeCAD. Follow these instructions when using them.
...
- **Bridge** (`working_bridge.py`): 13 MCP tools, async, communicates via MCP protocol over stdio
